  ...
  return (
    <div>
      <div className="grid grid-cols-4 gap-10 text-center pt-10 pb-8 text-white">
        <div className="p-4 rounded-lg mb-4 relative border-t-4 border-l-2 border-r-2 border-[#d753d2] shadow-xl" style={{backgroundColor:"rgba(59,51,100,255)"}}>
          <img
            src={bnb_img}
            alt="Small Image"
        ...
        <div className="bg-white p-4 rounded-lg mb-4 relative border-t-4 border-l-2 border-r-2 border-[#d753d2] shadow-xl" style={{backgroundColor:"rgba(59,51,100,255)"}}>
          <img
            src={load_img}
            alt="Small Image"
            className="w-16 h-16 absolute -top-10 left-1/2 transform -translate-x-1/2"
